...
public class HomeTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        genEvent = (LinearLayout)view.findViewById(R.id.addEvent);
        profImageHome = (ImageView)view.findViewById(R.id.profImageHome);
        ...
        genEvent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent launchGenEvent= new Intent(getActivity(),GenerateEvent.class);
                startActivity(launchGenEvent);
                getActivity().overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
            }
        });

        profImageHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public void onResume() {
        if(check_Network.isNetworkAvailable(getActivity())){
            ...
            Picasso.get().load(userProfImage).into(profImageHome);
            getEvents();
            super.onResume();
        }else{
            ...
            viewHolder.eveSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(saveflag[0]) {
                        ...
                        saveflag[0] = false;
                        Toast.makeText(getActivity(), "Event unsaved", Toast.LENGTH_SHORT).show();
                    }else{
