 ...
 */
public class DispSingleEve extends AppCompatActivity {

    String url, profimageurl, eveimagebaseurl, logMail, event_id, user_mail;
    LinearLayout genEventLayout;
    ImageView profImageHome;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        genEventLayout = (LinearLayout)findViewById(R.id.genEveLayout);
        genEventLayout.setVisibility(View.GONE);

        profImageHome = (ImageView) findViewById(R.id.profImageHome);
        eventList = (ListView) findViewById(R.id.eventListview);

        check_Network = new Chk_Network();
        asyncHttpClient = new AsyncHttpClient();
        requestParams = new RequestParams();
        mProgressDialogue = new ProgressDialog(DispSingleEve.this);
    }

    @Override
    public void onResume() {
        if(check_Network.isNetworkAvailable(DispSingleEve.this)){
            Intent intent = getIntent();
            event_id = intent.getStringExtra("event_id");
            getEvents();
            super.onResume();
        }else{
            Toast.makeText(DispSingleEve.this, "Turn on internet", Toast.LENGTH_SHORT).show();
            super.onResume();
        }
    }
    ...
    public class EventListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            adapter2 = new ViewImageAdapterServer(DispSingleEve.this, eventImageUrls.get(position));
            ...
            viewHolder.eventProfImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(!p.getProfileImage().isEmpty()){
                        ...
                        showCurrentProf.showDialog(DispSingleEve.this, p.getProfileImage());
                    }else{
                        Toast.makeText(DispSingleEve.this, "Profile Image is not available now.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            viewHolder.eventUsername.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(p.getEventUserMail().matches(logMail)){
                        ...
                        main2Activity.ProfIntent();
                    }else {
                        Intent intent = new Intent(DispSingleEve.this, OtherUserProfile.class);
            ...
            viewHolder.eveLike.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(likeflag[0]){
                        ...
                        Animation animation = AnimationUtils.loadAnimation(DispSingleEve.this,R.anim.bounce);
                        ...
                        if(dislikeflag[0]){
                            ...
                            Animation animation2 = AnimationUtils.loadAnimation(DispSingleEve.this,R.anim.blink_anim);
            ...
            viewHolder.eveComment.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(DispSingleEve.this, CommentsList.class);
            ...
            viewHolder.eveSend.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(DispSingleEve.this, "Send called :"+position, Toast.LENGTH_SHORT).show();
                }
            });
            ...
            viewHolder.eveShare.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(DispSingleEve.this, "Share called :"+position, Toast.LENGTH_SHORT).show();
                }
            });
            ...
            viewHolder.eveSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(saveflag[0]) {
                        ...
                        Animation animation = AnimationUtils.loadAnimation(DispSingleEve.this, R.anim.fadein);
                        viewHolder.eveSave.startAnimation(animation);
                        saveflag[0] = false;
                        Toast.makeText(DispSingleEve.this, "Event unsaved", Toast.LENGTH_SHORT).show();
                    }else{
                        updateNotification(p.getEventUserMail(), "save", p.getEventId(), "save");
                        viewHolder.eveSave.setImageResource(R.drawable.ic_bookmark_black_24dp);
                        Animation animation = AnimationUtils.loadAnimation(DispSingleEve.this, R.anim.fadein);
                        viewHolder.eveSave.startAnimation(animation);
                        saveflag[0] = true;
                        Toast.makeText(DispSingleEve.this, "Event saved", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            viewHolder.likesTag.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(p.getLikecnt() > 0){
                        Intent intent = new Intent(DispSingleEve.this, LikeDislikeListDisp.class);
                        intent.putExtra("event_id",p.getEventId());
                        intent.putExtra("flag","likes");
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                    }else{
                        Toast.makeText(DispSingleEve.this, "0 likes", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            viewHolder.dislikesTag.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(p.getDislikecnt() > 0){
                        ...
                        Toast.makeText(DispSingleEve.this, "0 dislikes", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    public void getEvents(){
        ...
        requestParams.put("flag", "singleEve");
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray array) {
                ...
                try {
                    ...
                    if (jsonArray.getString(0).matches("false")) {
                        ...
                        adapter=new EventListAdapter(DispSingleEve.this, arrayList);
                        eventList.setAdapter(adapter);
                        ListScrollHelper.getListViewSize(eventList);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(DispSingleEve.this, "some error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("error").matches("false")) {
                        if(jsonObject.getString("error").matches("false")){
                            //Toast.makeText(DispSingleEve.this, "Updated", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(DispSingleEve.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(DispSingleEve.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
