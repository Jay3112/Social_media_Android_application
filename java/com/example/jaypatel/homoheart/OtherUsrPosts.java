 ...
 */
public class OtherUsrPosts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myEventList = (ListView)view.findViewById(R.id.myEventListview);
        hintText = (TextView)view.findViewById(R.id.myPostText);
    ...
    public class EventListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            viewHolder.eventUsername.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ((OtherUserProfile)getActivity()).forScroll.setScrollY(0);
                }
            });
    ...
    public void getMyEvents(){
        ...
        String userMail = arguments.getString("userMail");
        ...
        requestParams.put("flag", "profile");
        requestParams.put("user_email",logMail);
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray array) {
                ...
                try {
                    ...
                    if (jsonArray.getString(0).matches("false")) {
                        ...
                        ListScrollHelper.getListViewSize(myEventList);
                    }
